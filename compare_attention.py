...
# Import the model architecture directly from your local AASIST.py
...
if __name__ == "__main__":
    ...
    genuine_audio = "./extract_audio/genuine/G1/thai0001.wav"
    mms_spoof_audio = "./extract_audio/MMS_spoof/mms_1/mms_thai0001.wav"
