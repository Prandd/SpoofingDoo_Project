...
if __name__ == "__main__":
    ...
    genuine_audio = str(_root / "data" / "raw" / "wav" / "CSS" / "Bona fide" / "Formal" / "Formal_spk1_utt1.wav")
    mms_spoof_audio = str(_root / "data" / "raw" / "wav" / "CSS" / "Spoofed" / "Formal" / "VITS_Formal_spk1_utt1.wav")
    if not Path(genuine_audio).exists():
        genuine_audio = str(_root / "extract_audio" / "CSS" / "Bona fide" / "Formal" / "Formal_spk1_utt1.wav")
    if not Path(mms_spoof_audio).exists():
        mms_spoof_audio = str(_root / "extract_audio" / "CSS" / "Spoofed" / "Formal" / "VITS_Formal_spk1_utt1.wav")
