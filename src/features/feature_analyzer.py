...
if __name__ == "__main__":
    ...
    base = _root / "data" / "raw" / "wav"
    if not base.exists():
        base = _root / "extract_audio"
    genuine_audio = str(base / "CSS" / "Bona fide" / "Formal" / "Formal_spk1_utt1.wav")
    spoofed_audio = str(base / "CSS" / "Spoofed" / "Formal" / "VITS_Formal_spk1_utt1.wav")
